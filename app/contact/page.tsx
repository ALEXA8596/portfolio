            ...
            <div className="space-y-6">
              <div>
                ...
                <a
                  ...
                  className="text-lg text-zinc-900 dark:text-white hover:text-blue-500 dark:hover:text-blue-400 transition-colors"
                >
              ...
              <div className="pt-6 border-t border-zinc-200 dark:border-zinc-700">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="flex items-center justify-center w-12 h-12 rounded-full bg-zinc-100 dark:bg-zinc-700 text-zinc-600 dark:text-zinc-300 hover:bg-zinc-200 dark:hover:bg-zinc-600 transition-colors"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
